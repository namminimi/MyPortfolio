...
<li className='p_function_title'>시작화면</li><ul><li>팀명 입력란 표시 구현</li><li>상대팀 컴퓨터 기능 구현</li><li>전광판 스트라이크, 볼, 아웃 구현</li><li>턴마다 회차, 공격인지 수비인지 표시 구현</li><li>입력한 팀명 표시 구현</li><li>홈으로 캐릭터 들어왔을 시 점수 구현</li></ul><li lassName='p_function_title'>공격</li><ul><li>스윙, 지켜보기, 스킬 버튼 표시 구현</li></ul><li lassName='p_function_title'>수비</li><ul><li>던지기, 스킬 버튼 표시 구현</li><li>판단 로그창 구현</li><li>각 버튼 성공 여부에 따라 스트라이크, 볼 구현 구현</li><li>1루, 2루, 3루 구현</li><li>안타, 홈런 성공 여부에 따라 캐릭터 이동 구현</li><li>공격/수비 교대 구현</li><li>승패 여부에 따라 사용자 결과 표시 구현</li></ul>
...
<li className='p_function_title'>시작화면</li><ul><li>Enter 누를 시 게임 시작 기능 구현</li></ul><li className='p_function_title'>방향키</li><ul><li>a, w, d, s 누를 시 캐릭터 위, 아래, 좌, 우 방향 이동 구현</li><li>위 아래 4차선 도로에 자동차 랜덤으로 출력 구현</li><li>총 목숨 3개 화면에 표시 구현</li><li>캐릭터와 자동차 충돌 시 원래 자리로 이동, 목숨 -1 기능 구현</li><li>캐릭터 도착지에 도착 시 원래 자리로 이동, 점수 +1 화면에 표시 기능 구현</li><li>점수를 얻거나 목숨을 잃을 시 메세지 표시 구현</li><li>목숨 0일 시 게임 종료 기능 구현</li><li>게임 끝날 시 Enter 누르면 재시작 기능 구현</li></ul>
...
<li>회원가입 & 로그인 기능 구현</li><li>장바구니 기능 구현</li><li>상품등록 기능 구현</li><li>상품 목록 페이지</li><li>상품 상세보기 페이지</li><li>리뷰 등록 기능 구현</li><li>DB 관리</li>
...
<li>로그인 & 회원가입 페이지</li><li>장르별 영화 페이지</li><li>검색 페이지</li><li>공지사항(쓰기,수정,삭제,페이지네이션)</li><li>자유게시판(쓰기,수정,삭제,페이지네이션)</li>
...
<li>로그인 & 회원가입 페이지</li><li>마이페이지</li><li>메인페이지</li><li>검색</li><li>상품 등록</li><li>상품 리스트 페이지</li><li>상품 상세보기 페이지</li><li>장바구니 페이지</li><li>공지사항 페이지</li><li>DB관리</li><li>각 api 구현</li>
...
<li>회원가입 & 로그인 페이지 & 반응형</li><li>(이번 프로젝트에서는 로그인&회원가입 구현할 때 react-hook-form 라이브러리와 내장되어있는 control을 사용하여 최대한 react-hook-form의 기능만 사용해서 구현하였다.)</li><li>공통 컴포넌트(dropdown&검색 기능, 이미지 추가)</li><li>컬럼 관리(모달)</li><li>할 일 카드 상세보기(모달)</li>
...
<li>공통컴포넌트(button, header)</li><li>온보딩페이지(공통)</li><li>지도페이지(공통) & 상세필터 & 반응형</li><li>캠핑장 상세페이지 퍼블리싱 & 반응형 & 지도 & 지도 모달</li><li>예약페이지 퍼블리싱 & 반응형</li><li>마이페이지(전체) & 내역 상세 페이지 & 후기등록 모달</li>